...
fRocksPath = fPath.replace("/net/ph2/auto/home", "/rocks")
...
for num in range(0,99):
    num_str=str(num)	
    if os.path.exists(fRocksPath+"/Output_Sample_mu_0_nui"+num_str+"_1.root"):
      nui_num = num
    elif os.path.exists(fRocksPath+"/Output_Sample_el_0_nui"+num_str+"_1.root"):
      nui_num = num
