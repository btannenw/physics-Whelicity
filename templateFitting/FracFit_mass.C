...
void FracFit_mass()
{
  std::string workDir = "/afs/cern.ch/work/m/mkareem/FitPackage_allinOne/output_mass";
/*
  std::string fitMod="Datafit"; // Datafit , Systematics, Calibration
  std::string angleMode= "lep"; // lep, had, lephad
  std::string bTag="2incl"; // 2incl , 1excl2incl
  std::string channel="el_mu"; //el_mu, el_mu_lephad, el_mu_bTag
  ...
  ofstream myfile;
  std::string fname=(workDir+"/"+fitMod+"_"+channel+"_"+bTag+"_3D_"+bkgMode+wmode+"_"+angleMode+"_Nominal_YIELDS.txt").c_str();
  cout<<fname<<endl;
  ...
  myfile<<"N_total= " << var.at(0)+var.at(3)+var.at(6) <<std::endl; 
  myfile<<std::setw(20)<<"Parameter"<< "\t|\t"<<std::setw(20)<<"Nominal \t|\t"<<std::setw(20)<<"Fit \t|\t" <<std::setw(15)<<"% Diff \t|\t"<< std::endl;
  myfile<<"========================================================================================================="<<endl;
