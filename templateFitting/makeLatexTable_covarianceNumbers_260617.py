   ...
   for key, value in sorted(lephadBTagDict.items()):
      ...
      for updown, value2 in sorted(lephadBTagDict[key].items(), reverse=True):
         ...
         if 'PartonShower' in updown or 'MEgenerator' in updown or 'Herwig' in updown:
            #print '\multirow{2}{*}{'+'{0}'.format(key.replace('_','\\_'))+'}'+'  &  & \multirow{2}{*}{'+'{0}'.format(round(float(lephadBTagDict[key][updown][fraction]),6))+'}      \\\\ \\hline'
            print '\multirow{2}{*}{'+'{0}'.format(key.replace('_','\\_'))+'}'+'  &  & \multirow{2}{*}{'+'{0}'.format(round(float(lepBTagDict[key][updown][fraction]),6))+'} & \multirow{2}{*}{'+'{0}'.format(round(float(hadBTagDict[key][updown][fraction]),6))+'} & \multirow{2}{*}{'+'{0}'.format(round(float(lephadBTagDict[key][updown][fraction]),6))+'}   \\\\ \\\\ \\hline'
         #radiation
         if 'mu=2' in updown:
            #print '\multirow{2}{*}{'+'{0}'.format(key.replace('_','\\_'))+'}'+'      & radHi   &     {0} & {1} & {2}     \\\\'.format(round(float(lepBTagDict[key][updown][fraction]),4), round(float(hadBTagDict[key][updown][fraction]),4), round(float(lephadBTagDict[key][updown][fraction]),6))
            print '\multirow{2}{*}{'+'{0}'.format(key.replace('_','\\_'))+'}'+'      & radHi   &     {0}     &     {1}     &     {2}     \\\\'.format(round(float(lepBTagDict[key][updown][fraction]),4), round(float(hadBTagDict[key][updown][fraction]),4), round(float(lephadBTagDict[key][updown][fraction]),6))
         if 'mu=0' in updown:
            #print '                          & radLo &     {0}         \\\\ \\hline'.format(round(float(lephadBTagDict[key][updown][fraction]),6))
            print '                          & radLo &     {0}     &     {1}     &     {2}         \\\\ \\hline'.format(round(float(lepBTagDict[key][updown][fraction]),4), round(float(hadBTagDict[key][updown][fraction]),4), round(float(lephadBTagDict[key][updown][fraction]),6))
   ...
   for key, value in sorted(lephadBTagDict.items()):
      ...
      for updown, value2 in sorted(lephadBTagDict[key].items(), reverse=True):
         ...
         if '_up' in updown or 'Up' in updown or 'UP' in updown or 'scaleup' in updown:
            #print '\multirow{2}{*}{'+'{0}'.format(key.replace('_','\\_'))+'}'+'      & up   &     {0}      \\\\'.format(round(float(lephadBTagDict[key][updown][fraction]),6))
            print '\multirow{2}{*}{'+'{0}'.format(key.replace('_','\\_'))+'}'+'      & up   &     {0}     &     {1}     &     {2}      \\\\'.format(round(float(lepBTagDict[key][updown][fraction]),4), round(float(hadBTagDict[key][updown][fraction]),4), round(float(lephadBTagDict[key][updown][fraction]),6))
         if '_down' in updown or 'Down' in updown or 'DOWN' in updown or 'scaledown' in updown:
            #print '                                       & down &     {0}           \\\\ \\hline'.format(round(float(lephadBTagDict[key][updown][fraction]),6))
            print '                                       & down &     {0}     &     {1}     &     {2}       \\\\ \\hline'.format(round(float(lepBTagDict[key][updown][fraction]),4), round(float(hadBTagDict[key][updown][fraction]),4), round(float(lephadBTagDict[key][updown][fraction]),6))
         # single-sided uncertainties
