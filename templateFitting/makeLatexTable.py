...
def makeFullTable( whichFraction, lepBTagDict, hadBTagDict, lephadBTagDict):
   ...
   print "Systematic uncertainty & Up/Down & Leptonic 2incl & Had 2incl & Had 1excl+2incl \\\\\\hline"
...
def callUncertainties(region, i, whichFraction):
   ...
   TopMass_hadBTag          = [0.003, 0.009, 0.006]
...
#makeFullSensitivityTable('F0', d_lep2incl, d_lephad2incl, d_lephadBTag, 'alt')
#makeFullSensitivityTable('F0', d_lepBTag, d_hadBTag, d_lephadBTag, 'alt')
#makeFullSensitivityTable('F0', d_lep2incl, d_had2incl, d_hadBTag, 'alt')
#makeFullSensitivityTable('FL', d_lep2incl, d_lephad2incl, d_lephadBTag, 'alt')
#makeFullSensitivityTable('FL', d_lep2incl, d_had2incl, d_lephadBTag, 'alt')
#makeFullSensitivityTable('FR', d_lep2incl, d_had2incl, d_hadBTag, 'alt')
...
#makeFullSensitivityTable('FL', d_lep2incl, d_lephad2incl, d_lephadBTag, 'alt')
#setUncertainties(r0, r1, r2, 'FR') 
#makeFullSensitivityTable('FR', d_lep2incl, d_lephad2incl, d_lephadBTag, 'alt')
